...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../bin/ExtremeExorcism.data';
      var REMOTE_PACKAGE_BASE = 'ExtremeExorcism.data';
...
Module['FS_createPath']("/resources", "maps", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_../bin/ExtremeExorcism.data');

      };
      Module['addRunDependency']('datafile_../bin/ExtremeExorcism.data');
    ...
    loadPackage({"files": [{"filename": "/resources/things.png", "start": 0, "end": 6885}, {"filename": "/resources/characters.png", "start": 6885, "end": 16781}, {"filename": "/resources/basictiles.png", "start": 16781, "end": 24297}, {"filename": "/resources/maps/m1.txt", "start": 24297, "end": 24453}], "remote_package_size": 24453, "package_uuid": "47c62b24-8342-4d29-a91d-9aa46e78bb5a"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'ExtremeExorcism.wasm';
...
var ASM_CONSTS = {
 ...
 107892: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 108881: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0; },  
 108974: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 109043: () => { return window.innerWidth; },  
 109073: () => { return window.innerHeight; }
};
